        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Watch on your TVs, Playstaion, Xbox, Chromecast, Apple TV, Blu-ray
              players, and more.
            </p>
          </div>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Stream unlimited movies and TV shows on your phone, table, and TV.
            </p>
          </div>

          {/* RIGHT SIDE */}

          <div className="flx-1 relative overflow-hidden">
            <img
              src="/device-pile.png"
              alt="Device image"
            ...
            />
            <video
              className="absolute top-8 left-1/2 -translate-x-1/2 h-4/6 z-10
              max-w-[63%]"
              playsInline
              autoPlay={true}
              muted
      ...
      <div className="py-10 bg-black text-white">
        ...
        >
          ...
          <div className="flex-1 relative">
            <img src="/kids.png" alt="Kids cartoon image" className="mt-4" />
          </div>
